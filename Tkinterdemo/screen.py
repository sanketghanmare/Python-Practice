...
rbValue.set(1)  # Default Value of radio button
...
monthSpin = tkinter.Spinbox(dateFrame, width=5, values=("Jan", "Feb",
                                                        "Mar", "Apr",
                                                        "May", "Jun",
                                                        "Jul", "Aug",
                                                        "Sep", "Nov",
                                                        "Dec"))
yearSpin = tkinter.Spinbox(dateFrame, width=5, from_=1990, to=2100)
